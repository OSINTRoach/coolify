<div>
    ...
    <form wire:submit="submit">
        ...
        @if ($useCustomRegistry)
            <div class="pt-4">
                <x-forms.select multiple id="selectedRegistries" wire:model="selectedRegistries"
                    label="Select Registries" required helper="Select one or more registries to pull the image from">
